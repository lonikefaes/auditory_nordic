...
create_vmp(folderOut, [subj, '_FMaps_singleTrials_0_05.vmp'],VTCInfo,[tst_bn',tst_An',tst_AnNS', tst_bn_thr', tst_An_thr', tst_AnNS_thr'],roi_large,{'Fbn','Fan','Fan_NoNoise','Fbn_th','Fan_th','Fan_NoNoise_th'});
