...
%     
    ...
    set(h,'XTick',unique(rois(:)))
    set(h,'XTickLabel',roiNames,'TickLabelInterpreter','Latex');
    title('Complete H','interpreter','Latex')
    ylabel('$\beta$  \% change','interpreter','Latex')
    ...
    set(h,'XTickLabel',roiNames,'TickLabelInterpreter','Latex');
    ylabel('$\beta$  \% change','interpreter','Latex')
    title('Complete L','interpreter','Latex')
    legend('Original', 'NORDIC', 'NORDIC No Noise', 'Location', 'northeast')
    ...
    set(h,'XTickLabel',roiNames,'TickLabelInterpreter','Latex');
    ylabel('$\beta$  \% change','interpreter','Latex')
    title('Oddball H','interpreter','Latex')
    ...
    set(h,'XTickLabel',roiNames,'TickLabelInterpreter','Latex');
    ylabel('$\beta$  \% change','interpreter','Latex')
    title('Oddball L','interpreter','Latex')
    ...
    set(h,'XTickLabel',roiNames,'TickLabelInterpreter','Latex');
    ylabel('$\beta$  \% change','interpreter','Latex')
    title('Unexp H','interpreter','Latex')
    ...
    set(h,'XTickLabel',roiNames,'TickLabelInterpreter','Latex');
    ylabel('$\beta$  \% change','interpreter','Latex')
    title('Unexp L','interpreter','Latex')
